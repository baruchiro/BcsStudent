...
<!-- /wp:paragraph --><!-- wp:list --><!-- /wp:list --><p><a href="https://www.jetbrains.com/student/" target="_blank" rel="noopener noreferrer"><strong>JetBrains- סביבות פיתוח</strong></a></p>
...
<p>עוד ספק של שירותי ענן. בעקרון שירותי הענן הם מתחרים, לכן לרובם יש תכונות דומות. בAWS יש הרבה שימוש במכונות וירטואליות, ותוכלו להרים לעצמכם מחשב לינוקס מרוחק, אם למשל אתם רוצים להריץ קוד לאורך זמן בלי הפסקה.</p>		
										<img src="https://www.bcsstudent.com/wp-content/uploads/2019/03/AWS-General_AWS-Cloud_light-bg.svg" alt="" height="50" width="50" />											
			<h3>רשימות נוספות של כלים בחינם</h3>		
					...
					<a href="https://education.github.com/pack" target="_blank" rel="noopener noreferrer">						
								...
								<li >
					<a href="https://github.com/AchoArnold/discount-for-student-dev" target="_blank" rel="noopener noreferrer">						
