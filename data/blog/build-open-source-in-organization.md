...
tags: [Open-Source]
ragQuestions:
  - 'איך בונים מוצר מבוסס קוד פתוח בארגון?'
  - 'מה צריך לבדוק לפני שמסתמכים על ספריית קוד פתוח בארגון?'
  - 'איך עובדים נכון מול פרויקט קוד פתוח שהמוצר מסתמך עליו?'
  - 'כדאי לתרום כסף או קוד למתחזק של פרויקט קוד פתוח?'
  - 'מה הסיכונים של שימוש בקוד פתוח במוצר מסחרי?'
  - 'איך יוצרים קשר עם מוביל פרויקט קוד פתוח ולמה זה חשוב?'
  - 'מתי כדאי לבסס מוצר על קוד פתוח ומתי לא?'
type: Blog
---
