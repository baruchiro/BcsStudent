...
<Note>
כמה דברים שכדאי לדעת: הקובץ מפנה ל`shared.env` שמחזיק משתנים משותפים כמו `TZ` ו`PUID`/`PGID`, ותיקיית ה`data` מוגדרת כvolume חיצוני (`external: true`) כי יצרתי אותה ידנית והיא די גדולה, אז אני לא נותן לcompose ליצור או למחוק אותה.
</Note>
