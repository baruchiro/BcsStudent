...
עד עכשיו כל הבקשות להוריד תוכן חדש עברו דרכי, ישירות מול _Sonarr_ ו_Radarr_. זה עובד לי מצוין, אבל אני לא רוצה שכל בן משפחה יצטרך ללמוד את הכלים האלה (וגם לא בטוח שאני רוצה שהם יגעו בהם 😉).

בשביל זה יש _[Jellyseerr](https://docs.jellyseerr.dev/)_, שנותן ממשק נוח, כמו נטפליקס, שבו כל אחד יכול לחפש סרט או סדרה וללחוץ "בקש לצפות". הבקשה עוברת אוטומטית ל_Sonarr_ או ל_Radarr_, שמתחילים בכל התהליך שתיארתי למעלה, ובסוף התוכן פשוט מופיע ב_Jellyfin_.

יש אפילו אפליקציה לטלפון שמשלבת את _Jellyfin_ ו_Jellyseerr_ יחד: חלק מהתוכן כבר זמין לצפייה, וחלק ממתין ללחיצה על "בקש", ואחרי זמן קצר גם הוא מוכן. ממש נטפליקס פרטי בבית.

### Cleanuparr

_[Cleanuparr](https://github.com/Cleanuparr/Cleanuparr)_ אמור לנקות הורדות תקועות, כושלות או "זבל" מהתור של _Sonarr_ ו_Radarr_ ומקליינט ההורדות, כדי שהמערכת לא תיתקע על קבצים שלא באמת ירדו כמו שצריך.
