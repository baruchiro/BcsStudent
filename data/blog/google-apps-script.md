...
tags: ['code', 'javascript', 'integrations']
summary: |
...
ragQuestions:
  - 'מה זה Google Apps Script ולמה הוא שימושי?'
  - 'איך מריצים אוטומציה או סקריפט בענן בחינם?'
  - 'איך בונים פתרון serverless בלי להרים שרת?'
  - 'איך מחברים בוט טלגרם ל-Google Apps Script?'
  - 'איך משתמשים ב-Google Sheets כמסד נתונים לסקריפט?'
  - 'איך מתזמנים סקריפט שירוץ אוטומטית עם טריגרים ב-Apps Script?'
  - 'איך משתמשים בספריות חיצוניות ב-Google Apps Script?'
type: Blog
---
...
![הוספת טריגר](/static/images/google-apps-script/add-trigger.png)
