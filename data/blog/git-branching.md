...
ragQuestions:
  ...
  - 'מה זה merge commit ולמה כדאי להימנע ממנו?'
  - "איך עובדים נכון עם בראנץ' פרטי בגיט?"
  - 'מה זה squash and merge ומתי להשתמש בו?'
  - 'איך משתמשים ב-rebase אינטראקטיבי כדי לתקן קומיטים?'
  - 'מה זה git push --force-with-lease ולמה הוא בטוח יותר?'
  - 'איך מנהלים קונפליקטים בזמן rebase?'
---
