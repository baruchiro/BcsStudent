...
<!-- wp:paragraph -->
<p>אז זהו, <a rel="noreferrer noopener" aria-label="יש קוד בPython (opens in a new tab)" href="https://github.com/baruchiro/BcsStudent/tree/master/generator" target="_blank">יש קוד בPython</a> שאוסף את כל המושגים ומציג אותם פה בתחתית, וגם ב<a rel="noreferrer noopener" aria-label="דף הנפרד (opens in a new tab)" href="https://www.bcsstudent.com/terms/" target="_blank">דף הנפרד</a>. הקוד כתוב לא בצורה הכי נקייה, אז אתם מוזמנים להציע עריכות משלכם, או ללכת לפי ה<a href="https://github.com/baruchiro/BcsStudent/issues" target="_blank" rel="noreferrer noopener" aria-label="Issues שפתוחים בgithub (opens in a new tab)">Issues שפתוחים בgithub</a>.</p>
<!-- /wp:paragraph -->