...
<!-- wp:paragraph -->
<p>(אגב, כמו שאמרנו בפרק <a href="https://www.bcsstudent.com/open-source/">קוד פתוח</a>, לא נשארנו להסתכל מהצד. ראינו שחסרה תמיכה, וראינו שה<a rel="noreferrer noopener" aria-label="Issue (opens in a new tab)" href="https://github.com/dotnet/corefx/issues/22660" target="_blank">Issue</a> מסומן כup-for-grabs, אז שאלנו איך אפשר לעזור. בסוף התשובה הייתה לכתוב קוד בC שהוא משותף לכל מערכות ההפעלה, והרגשנו שזה קצת גדול עלינו מבחינת כמות הזמן שאנחנו יכולים להשקיע.)</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>אז עברנו לאופציה השנייה- Python. בעזרת כלי שנקרא <a href="http://www.pyinstaller.org/" target="_blank" rel="noreferrer noopener" aria-label="PyInstaller (opens in a new tab)">PyInstaller</a>, ניתן ליצור מקוד פייתון קובץ הרצה עבור כל מערכת הפעלה. בנוסף, בפייתון יש כמה ספריות שעוזרות לנו לקבל את המידע על מפרט המחשב.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>אם השאלון עושה בעיות, <a href="https://goo.gl/forms/x3V0nr4VENdYSint2" target="_blank" rel="noreferrer noopener" aria-label="נשמח אם תענו עליו כאן (opens in a new tab)">נשמח אם תענו עליו כאן</a>.</p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScSrrSZaUUs0nJFEeSmXYyjEyRAdKxD2VOV2pF4crHM4mLthw/viewform?embedded=true" width="640" height="2782" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
<!-- /wp:html -->
