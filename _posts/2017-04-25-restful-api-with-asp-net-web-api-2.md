...
<!-- wp:paragraph -->
<p>המאמר הוא קודם כל סיכום בשבילי, כדי שבפעמים הבאות אני אוכל לבצע מהר יותר. לכן יש דברים שאני לא מרחיב בהם, וכמובן שמומלץ להסתכל <a href="https://docs.microsoft.com/en-us/aspnet/web-api/overview/" target="_blank" rel="noopener noreferrer">במקור</a>.</p>
<!-- /wp:paragraph -->
...
<!-- wp:image {"id":558} -->
<figure class="wp-block-image"><img src="https://baruchiro.files.wordpress.com/2017/04/e2808fe2808fd79cd79bd799d793d794.png" alt="Select Controller" class="wp-image-558"/></figure>
<!-- /wp:image -->
